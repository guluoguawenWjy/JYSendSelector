...
static id vk_targetCallSelectorWithArgumentError(id target, SEL selector, NSArray *argsArr){
...
@implementation UIResponder (VKMsgSend)

- (id)VKCallSelector:(SEL)selector param:(NSArray *)paramArr {
    return vk_targetCallSelectorWithArgumentError(self, selector, paramArr);
}
